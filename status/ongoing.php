...
<head>
    <title>Ongoing Anime on RG Anime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Ongoing Anime on RG Anime">
    ...
    <meta property="og:title" content="Ongoing Anime on RG Anime">
    <meta property="og:description" content="Ongoing Anime on RG Anime in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
								$ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$api/ongoing-anime?page=$page");
                               ...
                               // $json = json_decode($json, true);
                                foreach((array) $json as $key => $ongoing) { ?>
                                    <div class="flw-item">
                                        <div class="film-poster">
                                            ...
                                            <img class="film-poster-img lazyload"
                                                data-src="https://ik.imagekit.io/<?=$imgk?>/tr:f-webp/<?=$ongoing['imgUrl']?>"
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
										 $ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$api/ongoingPage?page=$page");
								  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
								  curl_setopt($ch, CURLOPT_HEADER, FALSE);
								  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json"));
								  $ongoingPage = curl_exec($ch);
