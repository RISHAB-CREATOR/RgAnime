...
<head>
    <title><?=$id?> on RG Anime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="<?=$id?> on RG Anime">
    ...
    <meta property="og:title" content="<?=$id?> on RG Anime">
    <meta property="og:description" content="<?=$id?> on RG Anime in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
								$ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$api/genre/$genre?page=$page");
                                ...
                                foreach((array) $json as $key => $genreFetch) { ?>
                                    <div class="flw-item">
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
										$ch = curl_init();
								  curl_setopt($ch, CURLOPT_URL, "$api/genrePage?genre=$genre&page=$page");
								  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
								  curl_setopt($ch, CURLOPT_HEADER, FALSE);
								  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json"));
								  $genreFetchPage = curl_exec($ch);
