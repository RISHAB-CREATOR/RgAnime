...
<head>
    <title>Watch <?=$title['romaji']?> - RG Anime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$title['romaji']?> - RG Anime" />
    <meta name="description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On RG Anime" />
    ...
    <meta property="og:title" content="Watch <?=$title['romaji']?> - RG Anime">
    <meta property="og:description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On RG Anime.">
    ...
    <meta property="twitter:title" content="Watch <?=$title['romaji']?> - RG Anime">
    <meta property="twitter:description" ontent="<?=substr($getAnime['description'],0, 90)?>.... Read More On RG Anime.">
