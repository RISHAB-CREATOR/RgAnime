...
<head>
    <title>Watch <?=$getAnime['name']?> - RG Anime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$getAnime['name']?> - RG Anime" />
    <meta name="description" content="<?=substr($getAnime['synopsis'],0, 90)?>.... Read More On RG Anime" />
    <meta name="keywords" content="RG Anime, watch anime online, free anime, anime stream, anime hd, english sub, kissanime, gogoanime, animeultima, 9anime, 123animes, RG Anime, vidstreaming, gogo-stream, animekisa, zoro.to, gogoanime.run, animefrenzy, animekisa" />
    <meta name="charset" content="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1" />
    <meta name="robots" content="index, follow" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <meta http-equiv="Content-Language" content="en" />
    <meta property="og:title" content="Watch <?=$getAnime['name']?> - RG Anime">
    <meta property="og:description" content="W<?=substr($getAnime['synopsis'],0, 90)?>.... Read More On RG Anime.">
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="RG Anime">
    ...
    <meta property="twitter:title" content="Watch <?=$getAnime['name']?> - RG Anime">
    <meta property="twitter:description" ontent="W<?=substr($getAnime['synopsis'],0, 90)?>.... Read More On RG Anime.">
                    ...
                    <div class="container">
                        ...
                        <div class="anis-content">
                            ...
                            <div class="anisc-detail">
                                ...
                                <div class="film-text m-hide">RG Anime is a site to watch online anime like <strong><?=$getAnime['name']?></strong> online, or you can even watch <strong><?=$getAnime['name']?></strong> in HD quality</div>
                            ...
                            <div class="anisc-info-wrap">
                                <div class="anisc-info">
                                    ...
                                    <div class="film-text w-hide">RG Anime is a site to watch online anime like <strong><?=$getAnime['name']?></strong> online, or you can even watch <strong><?=$getAnime['name']?></strong> in HD quality</div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="clearfix"></div>
