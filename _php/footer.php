<div id="footer"
    ...
    <div id="footer-about">
        <div class="container">
            <div class="footer-top">
                ...
                <div class="footer-joingroup">
                    <div class="zoro-group">
                        <div class="zrg-title"><span class="top">Join now</span><span class="bottom">RG Anime
                                Groups</span></div>
                        <div class="zrg-list">
            ...
            <div class="about-text">RG Anime does not store any files on our server, we only share link to the
                media which is hosted on 3rd party services.</div>
            <p class="copyright">Served with <i class="fas fa-heart"></i> <a href="https://itzrishabtools.me">RG Anime</a> 2023. Frontend by Rishab</p>
        </div>
    </div>
        </div>
    </div>
