...
<div id="header" class="header-home ">
    <div class="container">
        ...
        <a href="<?=$websiteUrl?>/home" id="logo" title="RG Anime">
            <img src='https://media.discordapp.net/attachments/1142685864816824330/1144898832279285850/logo.png?width=993&height=253' width="100%" height="auto"
                alt="RG Anime">
            <div class="clearfix"></div>
        </a>
        <div id="search">
        ...
        <div class="header-group">
            <div class="zoro-group">
                <div class="zrg-title"><span class="top">Join now</span><span class="bottom">RG Anime Groups</span></div>
                <div class="zrg-list">
