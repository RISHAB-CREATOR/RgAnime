...
<head>
    <title><?=$name?> on RG Anime</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="<?=$name?> on RG Anime">
    ...
    <meta property="og:title" content="<?=$name?> on RG Anime">
    <meta property="og:description" content="<?=$name?> on RG Anime in HD with No Ads. Watch anime online">
